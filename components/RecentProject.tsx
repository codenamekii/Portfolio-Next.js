    ...
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-24 gap-y-8 p-4 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div key={id} className=" sm:h-[41rem] h-[23rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
            <PinContainer title={link} href={link}>
              ...
              <div className="flex items-center mt-7 mb-3 justify-between">
                ...
                <div className="flex justify-center items-center">
                  <p className="flex md:text-xs lg:text-xl text-sm text-blue-200">Check Project</p>
                  <MdDoubleArrow className="ms-3" color="#CBECF9" />
                </div>
              </div>
            </PinContainer>
          </div>
